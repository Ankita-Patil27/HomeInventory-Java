...
public class HomeInventory extends JFrame
{
    ...
    JButton newButton = new JButton(new ImageIcon(getClass().getResource("new.gif")));
    JButton deleteButton = new JButton(new ImageIcon(getClass().getResource("delete.gif")));
    JButton saveButton = new JButton(new ImageIcon(getClass().getResource("save.gif")));
    JButton previousButton = new JButton(new ImageIcon(getClass().getResource("previous.gif")));
    JButton nextButton = new JButton(new ImageIcon(getClass().getResource("next.gif")));
    JButton printButton = new JButton(new ImageIcon(getClass().getResource("print.gif")));
